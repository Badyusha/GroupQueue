...
CREATE TABLE `user` (
    ...
    `username` VARCHAR(65) NULL DEFAULT NULL COLLATE 'utf8mb4_general_ci',
    `first_name` VARCHAR(65) NULL DEFAULT NULL COLLATE 'utf8mb4_general_ci',
    `last_name` VARCHAR(65) NULL DEFAULT NULL COLLATE 'utf8mb4_general_ci',
...
CREATE TABLE `schedule` (
    `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    `subject_name` VARCHAR(20) NULL DEFAULT NULL COLLATE 'utf8mb4_general_ci',
    `subject_full_name` VARCHAR(100) NULL DEFAULT NULL COLLATE 'utf8mb4_general_ci',
